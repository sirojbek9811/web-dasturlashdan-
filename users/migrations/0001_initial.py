    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(error_messages={'unique': 'Bu telefon raqamga ega foydalanuvchi oldindan mavjud'}, help_text='Required. 12 characters or fewer. Digits only.', max_length=12, unique=True, validators=[django.core.validators.RegexValidator(message="Telefon raqam quyidagi formatda bo'lishi kerak: '998 [XX] [XXX XX XX]'. 12 ta belgi", regex='^998[0-9]{9}$')], verbose_name='phone')),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('EMPLOYEE', 'Employee'), ('TEACHER', 'Teacher'), ('STUDENT', 'Student')], default='STUDENT', max_length=12)),
